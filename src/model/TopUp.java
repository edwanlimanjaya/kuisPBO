...
public class TopUp {
    ...
    private Enum Type_TopUp;

    public TopUp() {
    }

    public TopUp(String Id_TopUp, float Pajak_TopUp, double Harga_TopUp, Enum Type_TopUp) {
    ...
    public Enum getType_TopUp() {
        return Type_TopUp;
    }

    public void setType_TopUp(Enum Type_TopUp) {
        this.Type_TopUp = Type_TopUp;
    }
